    ...
    <div className="p-4 md:p-6 bg-slate-100 min-h-screen">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        {/* <Card
          ...
          headStyle={{ backgroundColor: PRIMARY_COLOR, borderBottom: "none" }}
        >
          <Form
            form={form}
            layout="vertical"
            onFinish={onCreateMenu}
            className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-4 gap-y-2 items-end"
          >
            <Form.Item
              name="eventId"
              label="Select Event"
            ...
            <Form.Item
              ...
              className="w-full"
            >
              <Select placeholder="Veg or Non-Veg?">
            ...
            <Form.Item
              ...
              className="w-full"
            >
              <Select placeholder="e.g., Recommended, Best, Featured">
            ...
            >
              <Input placeholder="E.g., Marinated cottage cheese, grilled" />
            </Form.Item>

        
            <Form.Item className="md:col-span-2 lg:col-span-1 xl:col-span-1 self-end w-full">
              <Button
                type="primary"
                htmlType="submit"
                loading={creating}
            ...
            locale={{
              emptyText: (
                <div className="text-gray-500 py-8 text-center">
                  <Paragraph>
                    No orders found for your assigned events at the moment.
                  </Paragraph>
                </div>
              ),
            }}
